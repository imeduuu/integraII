...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, children, title = 'Modal', size = 'medium', showCloseButton = true }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50" role="presentation">
      ...
      <div
        ...
        className={`relative bg-white rounded-lg shadow-lg p-6 z-10 ${sizeClasses[size]}`}
