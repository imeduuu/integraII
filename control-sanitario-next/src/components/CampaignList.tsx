    ...
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 tablet-portrait:grid-cols-2 tablet-landscape:grid-cols-3">
      {campaigns.map((campaign) => (
        ...
        >
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-2 tablet:text-lg">
          ...
          <p
            className={`mt-2 text-md font-bold tablet:text-lg ${
              campaign.active
          ...
          <button
            onClick={() =>
              handleRegister(campaign.id, campaign.title, campaign.active)
            }
